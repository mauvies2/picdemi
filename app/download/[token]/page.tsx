...
export default async function DownloadPage({
    ...
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground max-w-sm">
          This download link has expired. If you have a Picdemi account, your
          photos are still available in your library.
        </p>
  ...
  const guestOrder = await getGuestOrderWithItems(
    supabaseAdmin,
    downloadToken.guest_order_id,
  );
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      ...
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          ...
          ready to download · Links valid for 1 hour (refresh page if expired)
        </p>
      </div>
            ...
            >
              ...
              <div className="p-3">
                ...
                <a
                  ...
                  download={`picdemi-photo-${i + 1}.jpg`}
                >

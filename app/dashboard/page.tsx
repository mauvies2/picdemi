          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-xl border p-6">
              ...
              <div className="mt-4 grid gap-2">
                <a className="inline-flex h-9 items-center justify-center rounded-md bg-primary px-3 text-sm font-medium text-primary-foreground" href="/dashboard/events/new">
                  Create New Event
                </a>
                <a className="inline-flex h-9 items-center justify-center rounded-md border px-3 text-sm" href="/dashboard/events">
                  View Events
                </a>
              </div>
            </div>

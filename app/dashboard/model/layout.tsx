...
const links = [
  { href: "/dashboard/model", label: "Overview" },
  { href: "/dashboard/model/photos", label: "Your photos" },
  { href: "/dashboard/model/explore", label: "Explore" },
  { href: "/dashboard/model/profile", label: "Profile" },
  { href: "/dashboard/model/settings", label: "Settings" },
];
...
export default async function ModelLayout({
  ...
  // Sync role from URL - if active role is not "model", switch it
